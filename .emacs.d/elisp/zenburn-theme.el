...
;;;;; whitespace-mode
   `(whitespace-space ((t (:background ,zenburn-bg :foreground ,zenburn-bg+3))))
   `(whitespace-hspace ((t (:background ,zenburn-bg+1 :foreground ,zenburn-bg+3))))
   ...
   `(whitespace-space-before-tab ((t (:background ,zenburn-bg+1 :foreground ,zenburn-orange))))
   `(whitespace-indentation ((t (:background ,zenburn-bg+1 :foreground ,zenburn-yellow))))
